                ...
                <div class="card-header flex-column flex-md-row">
                    ...
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons">
                            @can('add.admin')
                                <a wire:navigate href="{{ route('add.admin') }}" class="btn btn-primary"><span><i
                                            class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add
                                            New Admin</span></span></a>
                            @endcan
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-inline-block text-nowrap">
                                        @can('edit.admin')
                                            <a wire:navigate href="{{ route('edit.admin', $item->id) }}"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click='deleteRow()'>Yes! Delete</button>
                </div>
